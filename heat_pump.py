...
if __name__ == '__main__':
    # print(read_heat_pump())
    print(read_ambient_conditions())
    # print(pd.DataFrame(perf()))
    pd.DataFrame(perf()).to_csv('heat_pump_performance.csv', index=False)
    # np.savetxt('heat_pump_performance.csv', pd.DataFrame(perf()), delimiter=",", fmt='%.3e')
